...
export async function getUserById(options?: { [key: string]: any }) {
...
/** 此处后端没有提供注释 PUT /user/update1 */
export async function update1(body: API.User, options?: { [key: string]: any }) {
  return request<boolean>('/user/update1', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
