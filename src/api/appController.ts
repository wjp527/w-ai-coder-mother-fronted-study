...
/** 此处后端没有提供注释 GET /app/export/code/${param0} */
export async function exportAppCodeToMd(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.exportAppCodeToMdParams,
  options?: { [key: string]: any }
) {
  const { appId: param0, ...queryParams } = params
  return request<string>(`/app/export/code/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
